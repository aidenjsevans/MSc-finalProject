...
void main() {
  ...
  testWidgets('Successfully add bouldering route to project library', (WidgetTester tester) async {
    ...
    await binding.watchPerformance(() async {
      ...
      final likeButton = find.byKey(Key('likeButton'));
      final dislikeButton = find.byKey(Key('dislikeButton'));
      await tester.scrollUntilVisible(likeButton, 800);
      ...
      final likeSnackBar = find.byKey( Key('successSnackBar'));
      expect(likeSnackBar, findsOneWidget);
    }, reportKey: 'like_or_dislike_bouldering_route_performance');
  });
}